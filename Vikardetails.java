...
public class Vikardetails extends JPanel
{
	...
	private JLabel fornavnlabel, etternavnlabel, alderlabel, bylabel, epostlabel, kategorilabel, tlflabel, lonnslabel, kjonnlabel, idlabel;

	public Vikardetails(Vikarregister v)
	{
		vikar = v;
		utskrift = new JTextArea(250,30);
